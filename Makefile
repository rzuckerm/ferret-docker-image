FERRET_VERSION := $(shell cat FERRET_VERSION)
FERRET_DEPS := $(wildcard FERRET_*)
DOCKER_TAG_PREFIX := rzuckerm/ferret:$(FERRET_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(FERRET_DEPS)
